...
export const ALL_PRODUCTS = "SELECT  products.id , products.name, products.description, products.price, products.stock, products.created_by, companies.company_name FROM products INNER JOIN companies ON products.created_by=companies.id  WHERE products.created_by=?;"
