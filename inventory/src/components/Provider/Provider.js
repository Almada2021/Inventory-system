        ...
        <>
            {
                ...
                ? null 
                :  
                <Background title={`Product ${provider.name}`}>
                 <div style={{width:"60%"}}>
